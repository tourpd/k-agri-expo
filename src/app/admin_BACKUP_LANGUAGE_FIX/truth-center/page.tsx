...
const assets = [
  {
    name: "안이영 고객교육 30년 자료",
    type: "교육·현장지식",
    data: "PPT / 강의안 / 병해충 설명 / 고객교육 사례",
    truth: "고객이 실제 현장에서 반복해서 묻는 문제를 정리한 자료",
    status: "자료 정리 필요",
  ...
  },
  {
    ...
    truth: "고객은 이론보다 지금 내 밭에서 먹히는 해결책을 원함",
    status: "구조화 필요",
    next: "고추 탄저병 사례부터 정리",
  },
  {
    ...
    <main style={S.page}>
      <div style={S.wrap}>
        ...
        <section style={S.hero}>
          <div>
            ...
            <h2 style={S.heroTitle}>
              고객을 움직이는 힘은 예쁜 콘텐츠가 아니라 검증된 진실입니다.
            </h2>
            <p style={S.heroText}>
        ...
        <section style={S.kpiGrid}>
          ...
          <Kpi title="판단 기준" value="진실" desc="고객을 움직이는 근거" />
        </section>
