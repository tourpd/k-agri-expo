...
export default function FarmerProfileBox({
  ...
  async function loadProfile() {
    ...
    try {
      ...
      if (!data?.success) {
        setMessage(data?.error || "농민 프로필 조회 실패");
        return;
      }
      ...
      setMessage("농민 프로필 조회 중 네트워크 오류");
    } finally {
      setLoading(false);
    }
  }
  ...
  async function saveProfile() {
    ...
    try {
      ...
      if (!data?.success) {
        setMessage(data?.error || "농민 프로필 저장 실패");
        return;
      }
      ...
      setMessage("농민 프로필 저장 중 네트워크 오류");
    } finally {
      setSaving(false);
    }
  }
  ...
  return (
    <section style={S.card}>
      ...
      <div style={S.infoGrid}>
        <Info label="농민명" value={farmerName} />
