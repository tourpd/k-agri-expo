    ...
    <main style={S.page}>
      ...
      <section style={S.toolbar}>
        ...
        <input
          ...
          placeholder="농민명 / 전화번호 / 주소 / 작물 / 제품명 / 송장번호 / 주문ID 검색"
          style={S.search}
        />
      ...
      <section style={S.quickPanel}>
        <div>
          ...
          {tab === "problem" && "농민명, 전화번호, 주문수량 누락 또는 취소 주문입니다."}
        </div>
        ...
        <section style={S.modalOverlay} onClick={() => setSelectedOrder(null)}>
          <div style={S.modalBox} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={S.detailGrid}>
              ...
              <Detail label="농민명" value={selectedOrder.farmer_name} />
