      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-8 grid gap-5 md:grid-cols-4">
          ...
          <StrategyCard
            title="핵심 진단"
            value="자산 연결"
            desc="홈페이지·PDF·영상·제품·농민 데이터를 연결"
            bg="bg-white"
          />
        ...
        <section className="mt-8 rounded-3xl bg-white p-8 shadow-xl ring-1 ring-stone-200">
          ...
          <div className="mt-8 grid gap-5 lg:grid-cols-3">
            ...
            <FlowCard
              no="02"
              title="AI 전략회의실"
              desc="기업분석, 농민심리, 콘텐츠, 공동구매, 성장전략 관점에서 토론합니다."
              href={`/admin/sales-automation/${id}/meeting`}
              button="전략회의실 열기"
            />
        ...
        <section className="mt-8 rounded-3xl border-4 border-black bg-stone-50 p-8">
          ...
          <p className="mt-3 text-2xl font-bold text-black">
            제품 나열형 홈페이지에서 농민 문제 해결형 AI 작물솔루션 플랫폼으로 전환합니다.
          </p>
          ...
          <div className="mt-8 grid gap-5 lg:grid-cols-3">
            <ConceptCard
              ...
              title="농민 고민센터"
              score="우선"
              desc="농민은 제품명을 찾지 않고 문제를 찾습니다. 총채벌레, 탄저병, 칼슘결핍, 일소피해 중심으로 진입시킵니다."
