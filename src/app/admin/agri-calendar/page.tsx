    ...
    <main className="min-h-screen bg-slate-100 text-slate-950">
      ...
      <section className="w-full px-8 py-6">
        <div className="rounded-lg border bg-white p-6">
          ...
          <h2 className="mt-2 text-3xl font-black">자료에서 고객 발송용 캘린더를 자동 생성</h2>
          <p className="mt-2 text-lg font-bold text-slate-600">
            고객이 농자재를 써야 할 시점보다 최소 2주 전에 정보·영상·농자재·공동구매를 연결하는 화면입니다.
          </p>
        ...
        <div className="mt-5 rounded-lg border bg-white">
          <div className="border-b px-5 py-4">
            <h3 className="text-2xl font-black">고객 발송용 월별 작업표</h3>
            ...
            <table className="w-full min-w-[1800px] border-collapse text-base">
              <thead>
                <tr className="bg-slate-200 text-left">
                  ...
                  <th className="border px-5 py-3">고객에게 보낼 정보</th>
